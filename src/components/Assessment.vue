<template>
  <div class="assessment">
    ...
    <p>Ces données ont de la valeur, <strong>beaucoup</strong> de valeur pour nous ! </p>

    <p>Avec celles-ci, n'importe quel agrégateur peut, en recoupant d'autres jeux de données, fournir une liste
    ...
    <p>Pour en savoir plus sur la protection de vos données, nous vous invitons à vous rendre sur <a
      ...
      article</a> de l'assocation <em>Que Choisir</em>.</p>
  </div>
</template>
