...
export default {
  ...
  data() {
    return {
      ...
      allBonusQuestions: [
        {
          title: "De quel nationaliter étes-vous",
          type: "input",
        ...
        },
        {
          ...
          type: "input",
          questionLabel: "zipCode"
        },
        {
          title: "Dans quel ville/village habitez-vous",
          type: "input",
          questionLabel: "city"
        },
        {
          title: "Comment ce nomme la rue ou vous vivez",
          type: "input",
          questionLabel: "street"
        },
        {
